...
![Notas Profesor - Flutter](evidencias/nota-1.png)

#### 2. Agregando una nueva nota desde la App Flutter

![Agregando Nota - Flutter](evidencias/nota-2.png)

#### 3. Nota guardada correctamente + Visualización en la Plataforma Web

![Nota agregada flutter](evidencias/nota-3.png)

![Nota agregada en Web](evidencias/nota-5.png)

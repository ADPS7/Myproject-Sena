...
class AttendanceScreen extends StatelessWidget {
  ...
  Future<Map<String, dynamic>> _fetchAsistencias() async {
    ...
    final response = await http.get(
      Uri.parse('http://10.2.130.230:5000/asistencias/$userId'),
                  ...
                  child: Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Text(
                          "Control de asistencias por módulo",
                          style: TextStyle(
                  ...
                  sliver: modulos.isEmpty
                      ...
                      : SliverList(
                          delegate: SliverChildBuilderDelegate((
                            ...
                            final String moduloKey = modulos.keys.elementAt(
                              index,
                            );
